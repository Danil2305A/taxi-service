...
public class GlobalExceptionHandler {
    @ExceptionHandler({UserNotFoundException.class, NoAvailableDriversException.class})
    ...
    public ErrorResponse handleConflictError(DuplicatedUserException e, WebRequest request) {
        return buildError(e, HttpStatus.CONFLICT, request);
    }
    ...
    public ErrorResponse handleUnauthorizedError(InvalidUserCredentialsException e, WebRequest request) {
